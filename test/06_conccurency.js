...
describe('Concurrency', function() {                                                               // eslint-disable-line
    ...
    it('should push a blocking job', function() {                                                       // eslint-disable-line
        return tasqueue.pushJob(jobType1);
    });

    it('should push some other jobs', function() {                                                      // eslint-disable-line
    ...
    it('should be processing all jobs', function() {                                                    // eslint-disable-line
        return Q.delay(100)
        .then(function() {
